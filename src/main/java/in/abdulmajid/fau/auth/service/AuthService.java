package in.abdulmajid.fau.auth.service;

import in.abdulmajid.fau.auth.dto.AuthResponse;
import in.abdulmajid.fau.auth.dto.LoginRequest;
import in.abdulmajid.fau.auth.dto.SignupRequest;
import in.abdulmajid.fau.auth.dto.UpdateProfileRequest;
...
import in.abdulmajid.fau.auth.security.JwtTokenProvider;
import in.abdulmajid.fau.email.EmailService;
...
public class AuthService {
    ...
    private void sendVerificationEmail(User user) {
        ...
        emailService.sendEmail(user.getEmail(), "Verify your email — Fau", html);
    }
    ...
    private void sendResetPasswordEmail(User user) {
        ...
        emailService.sendEmail(user.getEmail(), "Reset your password — Fau", html);
    }
